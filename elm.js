...
var _user$project$Types$Model = F3(
	function (a, b, c) {
		return {time: a, frogger: b, windowSize: c};
	});
var _user$project$Types$Location = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _user$project$Types$Frogger = F2(
	function (a, b) {
		return {location: a, rotation: b};
	});
var _user$project$Types$ResizeWindow = function (a) {
...
var _user$project$Key$ArrowLeft = {ctor: 'ArrowLeft'};
...
var _user$project$Key$fromCode = function (keyCode) {
	...
	switch (_p0) {
		...
		case 37:
			return _user$project$Key$ArrowLeft;
		case 38:
	...
	return _elm_lang$core$Platform_Sub$batch(
		{
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$keyboard$Keyboard$downs(_user$project$Types$KeyDown),
				_1: {
					ctor: '::',
					_0: _elm_lang$window$Window$resizes(
						function (_p0) {
							var _p1 = _p0;
							return _user$project$Types$ResizeWindow(
								A2(_elm_lang$window$Window$Size, _p1.width, _p1.height));
						}),
					_1: {ctor: '[]'}
				}
			}
...
var _user$project$State$moveLocation = F3(
	function (location, dx, dy) {
		return _elm_lang$core$Native_Utils.update(
			location,
			{x: location.x + dx, y: location.y + dy});
	});
var _user$project$State$keyDown = F2(
		...
		switch (_p2.ctor) {
			case 'ArrowLeft':
				return _elm_lang$core$Native_Utils.update(
					...
					{
						frogger: A2(
							_user$project$Types$Frogger,
							A3(_user$project$State$moveLocation, model.frogger.location, -10, 0),
							90)
					});
			case 'ArrowUp':
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						frogger: A2(
							_user$project$Types$Frogger,
							A3(_user$project$State$moveLocation, model.frogger.location, 0, 10),
							0)
					});
			case 'ArrowRight':
				return _elm_lang$core$Native_Utils.update(
	...
	function (msg, model) {
		...
		switch (_p3.ctor) {
			...
			case 'KeyDown':
				return {
					ctor: '_Tuple2',
					_0: A2(_user$project$State$keyDown, _p3._0, model),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return {
...
var _user$project$State$initModel = function () {
	var location = A2(_user$project$Types$Location, 50, 20);
	var frogger = A2(_user$project$Types$Frogger, location, 0);
	return A3(
		_user$project$Types$Model,
		0.0,
		frogger,
		A2(_elm_lang$window$Window$Size, 500, 500));
}();
var _user$project$State$initialState = {
	ctor: '_Tuple2',
	_0: _user$project$State$initModel,
	_1: A2(
		_elm_lang$core$Task$perform,
		function (_p4) {
			var _p5 = _p4;
			return _user$project$Types$ResizeWindow(
				A2(_elm_lang$window$Window$Size, _p5.width, _p5.height));
		},
		_elm_lang$window$Window$size)
};

var _user$project$View$froggerView = function (frogger) {
	return A2(
		_evancz$elm_graphics$Collage$rotate,
		_elm_lang$core$Basics$degrees(frogger.rotation),
		A2(
			_evancz$elm_graphics$Collage$rotate,
			_elm_lang$core$Basics$degrees(19),
			A2(
				_evancz$elm_graphics$Collage$move,
				{ctor: '_Tuple2', _0: frogger.location.x, _1: frogger.location.y},
				A2(
					_evancz$elm_graphics$Collage$filled,
					A3(_elm_lang$core$Color$rgb, 0, 255, 0),
					A2(_evancz$elm_graphics$Collage$ngon, 5, 20)))));
};
					...
					model.windowSize.height,
					{
						...
						_0: A2(
							...
							A2(
								...
								_elm_lang$core$Basics$toFloat(model.windowSize.width),
								_elm_lang$core$Basics$toFloat(model.windowSize.height))),
						_1: {
							ctor: '::',
							_0: _user$project$View$froggerView(model.frogger),
							_1: {ctor: '[]'}
						}
					})),
			_1: {ctor: '[]'}
...
var _user$project$App$main = _elm_lang$html$Html$program(
	{init: _user$project$State$initialState, update: _user$project$State$update, subscriptions: _user$project$State$subscriptions, view: _user$project$View$rootView})();
