...
var _user$project$State$update = F2(
	function (msg, model) {
		...
		return {
			ctor: '_Tuple2',
			_0: _user$project$Types$Model(_p0._0),
			_1: _elm_lang$core$Platform_Cmd$none
		};
	});
var _user$project$State$initModel = _user$project$Types$Model(0.0);
var _user$project$State$initialState = {ctor: '_Tuple2', _0: _user$project$State$initModel, _1: _elm_lang$core$Platform_Cmd$none};
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Frogger'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
